...
```
wget https://github.com/stake-house/eth-wizard/releases/download/v0.7.2/ethwizard-0.7.2.pyz && sudo python3 ethwizard-0.7.2.pyz
```
...
Download and run [the wizard binary](https://github.com/stake-house/eth-wizard/releases/download/v0.7.2/ethwizard-0.7.2.exe)
