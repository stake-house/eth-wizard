...
Download and run [the ethwizard-0.9.14.exe binary](https://github.com/stake-house/eth-wizard/releases/download/v0.9.14/ethwizard-0.9.14.exe)

As an alternative, you can download and install [a recent version of Python](https://www.python.org/downloads/), make sure to install py launcher (it should be part of the default options), download [the ethwizard-0.9.14-win.pyz bundle](https://github.com/stake-house/eth-wizard/releases/download/v0.9.14/ethwizard-0.9.14-win.pyz) and double-click on it. This alternative is less likely to trigger your antivirus software.
